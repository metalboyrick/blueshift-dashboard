...
### Field-by-Field Serialization (Raccomended)
...
impl MultiDynamicAccount {
    ...
    pub fn parse_dynamic_fields(data: &[u8]) -> Result<(&[u8; 32], u64, &[u8], &[u8]), ProgramError> {
        ...
        let data_1 = &data[Self::MIN_SIZ..Self::MIN_SIZ + len];
        let data_2 = &data[Self::MIN_SIZ + len..]; // Remainder
    ...
    pub fn write_with_multiple_dynamic(
        ...
        // Write data1
        buffer[offset..offset + data_1.len()].copy_from_slice(data1);
        offset += data_1.len();
