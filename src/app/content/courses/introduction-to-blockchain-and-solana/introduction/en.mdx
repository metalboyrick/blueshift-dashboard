...
Your bank grows beyond what one computer can handle so now you split accounts evenly across different databases:
...
- Race Conditions: Two transfers from Alice happen simultaneously. Both check her $100 balance, both see sufficient fund, both proceed. Alice just spent an extra $100 she didn't have.
