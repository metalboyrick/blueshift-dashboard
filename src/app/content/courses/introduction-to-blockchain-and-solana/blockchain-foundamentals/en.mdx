...
Consensus and cryptographic primitives work together to create a "trustless" system. For the first time in history, trust is posed in mathematics and not in people:
