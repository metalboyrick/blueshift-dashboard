...
Tài khoản hệ thống không chứa dữ liệu và thuộc sở hữu của Chương trình Hệ thống. Sự khác biệt chính giữa tài khoản thanh toán và tài khoản chưa khởi tạo là số dư lamport: tài khoản thanh toán có tiền, trong khi tài khoản chưa khởi tạo bắt đầu với số dư trống.
