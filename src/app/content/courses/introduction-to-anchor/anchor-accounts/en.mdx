...
If you want to learn more about how to use `anchor-spl` you can follow the [SPL-Token Program with Anchor](blueshift.gg/en/courses/spl-token-with-anchor) or [Token2022 Program with Anchor](blueshift.gg/en/courses/token-2022-with-anchor) courses.
