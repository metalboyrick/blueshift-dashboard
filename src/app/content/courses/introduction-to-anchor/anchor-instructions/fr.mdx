...
**Remarque** : Vous pouvez trouver tous les CPIs du Programme Système en utilisant la crate Anchor principale : `use anchor_lang::system_program::*`. Pour celui relatif au Programme de Jetons SPL, nous devrons importer le crate anchor_spl et faire : `use anchor_spl::token::*`
