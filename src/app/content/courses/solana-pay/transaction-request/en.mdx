...
> Your application doesn't submit the transaction to the network, so you won't have access to the transaction signature for tracking purposes. Use reference parameters as explained in the [Introduction Lesson](/zh-CN/courses/solana-pay/introduction#reference)
