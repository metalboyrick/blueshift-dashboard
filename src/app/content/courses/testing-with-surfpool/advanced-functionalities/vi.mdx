...
Surfnet không chỉ sao chép mainnet trên localnet—nó cho phép bạn nâng cao và sửa đổi các tính năng cốt lõi của Solana bằng cách thay đổi tài khoản, biến hệ thống và trạng thái blockchain.

Những sửa đổi này diễn ra thông qua các lệnh gọi RPC đến Surfnet, cho phép thay đổi cả theo chương trình (cho môi trường kiểm thử tự động) và thông qua lệnh terminal (cho các hoạt động đơn lẻ).
