...
Das bedeutet, dass wir einfach die normalen `transferChecked()`, `burnChecked()`, ... Anweisungen verwenden und die `PermanetDelegate` Autorität im `authority` Feld übergeben können.