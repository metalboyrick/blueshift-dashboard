...
If you want to learn more about what additional functionalities are available and what are the differences with the Legacy token program, go follow [this course](/zh-CN/courses/token-2022-program)  
