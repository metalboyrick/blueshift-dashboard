...
Le Programme de Jeton fonctionne grâce à un ensemble d'instructions qui vous permettent de créer des jetons, d'initialiser des comptes de jetons, de transférer des jetons entre des comptes et de gérer les autorisations. 
...
Crée de nouveaux jetons et les dépose sur un compte donné. Seule l'autorité de mint peut effectuer cette opération.
