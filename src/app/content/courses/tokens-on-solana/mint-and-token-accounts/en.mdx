...
> With Token Extensions and the [Token2022 program](/zh-CN/courses/token-2022-program), this changes completely. The Metadata extension allows you to embed metadata directly into the mint account itself, eliminating the need for external programs.
