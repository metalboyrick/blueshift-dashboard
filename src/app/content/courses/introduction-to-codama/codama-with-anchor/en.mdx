...
Creating a Codama IDL from Anchor is extremely straightforward. Once you generate your Anchor IDL with anchor build, you can convert it directly using the `createFromRoot` function:
...
<ArticleSection name="Updating the IDL" id="updating-the-idl" level="h2" />

The real power of creating a Codama IDL from Anchor lies in using visitors to enhance and customize the generated structure. 

While Anchor provides the basic foundation, visitors add the polish that makes generated clients truly pleasant to use.

Let's examine the most important and useful visitors available:
