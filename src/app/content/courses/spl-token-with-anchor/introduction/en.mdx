...
On Solana everything token related is handled by the [SPL Token Program](https://github.com/solana-program/token) and the [Token2022 Program](/zh-CN/courses/token-2022-program): Solana's native token framework that defines how all tokens are created, managed, and transferred.
...
> If you're not familiar with anchor, we recommend you go through our [Anchor for Dummies](/zh-CN/courses/anchor-for-dummies) before moving forward.
