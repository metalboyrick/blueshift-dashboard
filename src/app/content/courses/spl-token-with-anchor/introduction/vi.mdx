...
Trên Solana, mọi thứ liên quan đến token đều được xử lý bởi [SPL Token Program](https://github.com/solana-program/token) và [Token2022 Program](/en/courses/token-2022-program): framework token native của Solana định nghĩa cách tất cả token được tạo, quản lý và chuyển giao.
