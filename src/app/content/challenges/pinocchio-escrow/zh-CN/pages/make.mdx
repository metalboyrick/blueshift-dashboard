...
**注意**：我们将使用 [Pinocchio 简介](/en/courses/introduction-to-pinocchio/pinocchio-accounts) 中介绍的类型。
...
在此步骤中，我们使用从[Pinocchio简介](/en/courses/introduction-to-pinocchio/pinocchio-accounts)中介绍的辅助函数的`ProgramAccount::init::<Escrow>`特性创建`Escrow`账户。同样，我们初始化Vault账户，因为它需要重新创建：
