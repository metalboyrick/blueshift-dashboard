...
> 如果您不熟悉Winternitz签名，请先阅读[Solana上的Winternitz签名](/en/courses/winternitz-signatures-on-solana)以了解核心概念和基础密码学。

在本次挑战中，我们将更新我们在[匹诺曹保险库挑战](/en/challenges/pinocchio-vault)中构建的简单Lamport保险库，使其支持Winternitz签名作为交易验证方法。
...
`lib.rs`中的入口点与我们在[Pinocchio简介课程](/en/courses/introduction-to-pinocchio)中介绍的内容非常相似。
