...
Nous continuons ensuite en activant `init-if-needed` sur le crate `anchor-lang` et en ajoutant le crate `anchor-spl` :
...
Comme vous le voyez, nous avons implémenté un discriminateur personnalisé pour les instructions. Veillez donc à utiliser Anchor version 0.31.0 ou plus ancienne.
