...
**Lưu ý**: Vì chúng ta chỉ cung cấp một `token_program` để đảm bảo rằng CPI không thất bại trong lệnh `take`, nơi chúng ta thực hiện chuyển với cả hai mint, chúng ta cần kiểm tra rằng hai mint được sở hữu bởi cùng một chương trình.
