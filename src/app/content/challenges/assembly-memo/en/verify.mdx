...
<RequirementList>
  <Requirement
    title="Challenge 1: Testing the Memo"
    description="Your program should suceed and log `Hello, Solana!`"
  />

  <Requirement
    title="Challenge 2: Testing the Memo with different input"
    description="To make sure that you didn't hardcode the `Hello, Solana!` string, we try again with another input: `Hello, Solana, but different!`"
  />
</RequirementList>
