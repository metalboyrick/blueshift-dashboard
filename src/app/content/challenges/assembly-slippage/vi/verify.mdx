...
<RequirementList>
  <Requirement
    title="Thử thách 1: Kiểm thử Slippage với SPL-Token"
    description="Chương trình của bạn nên thành công khi số lượng token trong một tài khoản SPL-Token lớn hơn số lượng được truyền vào."
  />

  <Requirement
    title="Thử thách 2: Kiểm thử trường hợp thất bại của Slippage"
    description="Chương trình của bạn nên thất bại khi số lượng token trong một tài khoản SPL-Token nhỏ hơn số lượng được truyền vào."
  />

<Requirement
    title="Thử thách 3: Kiểm thử Slippage với Token2022"
    description="Chương trình của bạn nên thành công khi số lượng token trong một tài khoản Token2022 lớn hơn số lượng được truyền vào."
  />
</RequirementList>