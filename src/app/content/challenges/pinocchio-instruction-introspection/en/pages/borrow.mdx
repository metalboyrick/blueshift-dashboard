...
As you can see, since the `token_accounts` are a dynamic number of accounts, we pass it in simlarly to how we pass `remaining_accounts`. 
...
- `amounts`: a dynamic array of loan amounts scine the user can request multiple loans in one transaction
