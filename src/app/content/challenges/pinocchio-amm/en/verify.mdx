...
<RequirementList>
  ...
  <Requirement
    ...
    description="Your program should allow a user to deposit into the liquidity pool of an Amm and calculate the amount of LP tokens they will receive for their contribution. Define an instruction to do this using an instruction discriminator value of `1`."
  />
